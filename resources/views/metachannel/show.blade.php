...
@section('navbar')
    ...
    <li><a href="{{ url("meta/$metachannel->id/update") }}" title="{{ $minutes.' minutes have past since last update' }}"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> Update</a></li>
